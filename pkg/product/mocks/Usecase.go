...
func (_m *Usecase) Add(p product.Product) (product.Product, error) {
	ret := _m.Called(p)
...
func (_m *Usecase) Products() ([]product.Product, error) {
	ret := _m.Called()
...
func (_m *Usecase) Search(code string) (product.Product, error) {
	ret := _m.Called(code)
...
func (_m *Usecase) Update(p product.Product) (product.Product, error) {
	ret := _m.Called(p)
